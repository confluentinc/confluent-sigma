...
export default function Detections(props) {
  ...
  useSubscription("/topic/splunk-s2s-events", (dnsTopic) => {
  ...
  useSubscription("/topic/firewalls", (dnsDetectionTopic) => {
    ...
    <>
      ...
      <Grid container spacing={4}>
        <Grid item xs={12}>
          ...
          <Grid item xs={12}>
            <DataTable title="Firewall Detection Data" topicData={dnsDetectionData}/>
          </Grid>
        </Grid>
        <Grid item xs={12}>
            <DataTable title="Splunk S2S Raw Data" topicData={dnsData}/>
          </Grid>
     </>
  );
}
